...
export default function Landing() {
  return (
    <div class="font-sans text-[#2E365A]">
      ...
      {/* Hero */}
      <section class="relative bg-cover bg-center h-[500px] flex items-center justify-center" style="background-image: url('src/assets/hero-camping.jpg')">
      ...
      <section class="bg-[#96AAC5] py-12 px-8 md:px-24">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {[
            { name: "Tenda 2 orang", price: "Rp.50.000/hari", img: "src/assets/tenda.png" },
            { name: "Kompor Lipat", price: "Rp.20.000/hari", img: "src/assets/kompor.png" },
            { name: "Nesting", price: "Rp.20.000/hari", img: "src/assets/nesting.png" },
            { name: "Headlamp", price: "Rp.15.000/hari", img: "src/assets/headlamp.png" },
          ].map((item) => (
