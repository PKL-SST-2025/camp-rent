...
export default function Tracking() {
  ...
  const [isLoading, setIsLoading] = createSignal(true); // state loading

  const loadData = () => {
    setIsLoading(true);
    setTimeout(() => { // kasih delay kecil biar smooth
  ...
  return (
    <Show when={!isLoading()} fallback={<div class="text-center mt-10 text-gray-500">Memuat...</div>}>
      {!params.id ? (
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 max-w-3xl mx-auto mt-8 fade-in">
          {data() ? (
            <>
