  ...
  return (
    <main class="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#96AAC5] to-[#FCEBEC] font-sans px-4">
      <div class="bg-white/40 backdrop-blur-md p-8 rounded-xl w-full max-w-sm shadow-md border border-white/20">
        {/* Title */}
        <h1 class="text-2xl font-bold text-center text-[#3F5B8B] mb-1">Masuk ke CampRent</h1>
        ...
        <A
          ...
          class="block text-center text-xs text-[#3F5B8B] mt-3 hover:underline"
        >
          Lupa Password?
        </A>
        ...
        <p class="text-xs text-center text-[#7A7A8B]">
          Belum punya akun?{" "}
          <A href="/register" class="text-[#6C5E82] hover:underline font-medium">
            Daftar di sini
          </A>
        </p>
      </div>
